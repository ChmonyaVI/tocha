(() => {
    ...
    function mobileSlider() {
        if (window.innerWidth <= 560.98 && "false" == slider.dataset.mobile) if (document.querySelector(".steps__slider")) {
            mySwiper = new core(".steps__slider", {
    ...
    mobileSlider();
    const sliderTrafic = document.querySelector(".rates__slider");
    let mySwiperOne;
    function mobileSliderOne() {
        if (window.innerWidth <= 767.98 && "false" == sliderTrafic.dataset.mobile) if (document.querySelector(".rates__slider")) {
            mySwiperOne = new core(".rates__slider", {
                modules: [ Navigation, Pagination ],
                observer: false,
                observeParents: true,
                slidesPerView: 1,
